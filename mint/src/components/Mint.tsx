...
const Mint: FC<IMintProps> = (props) => {
    ...
    const [ lamports, setLamports ] = useState(1000000000);
    ...
    const mintNFT: React.MouseEventHandler<HTMLButtonElement> = async (event) => {
    ...
    return (
        <>
            ...
            <p>My Balance: {myBalance / 1000000000} solana</p>
